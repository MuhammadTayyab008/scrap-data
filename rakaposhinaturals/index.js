...
async function runScraping() {
    try {
        const baseUrl = "https://rakaposhinaturals.com";
        const initialPageUrl = "/collections/all-our-goodies";
        const totalPages = 4;
        ...
        for (let page = 1; page <= totalPages; page++) {
            ...
            $("li.grid__item a.full-unstyled-link").each((index, element) => {
            ...
            for (const productLink of allProductLinks) {
                try {
                    ...
                    const productName = $("div.product__title")
                        ...
                        .replace(/\s+/g, " ")
                        .trim();
                    const price = $("span.price-item--regular")
                        .first()
                        .text()
                        .replace(/\s+/g, " ")
                        .trim();
